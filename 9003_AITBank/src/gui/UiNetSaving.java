 ...
 * @author kosuk
 */
public class UiNetSaving extends BankUi {
...
//                textArea.repaint();
    ...
    public void showDetails() {
        String acFName = n.getFirstName();  //  get user first name
        String acLName = n.getLastName();   //  get user last name
        String acNum = Integer.toString(n.getAccountNumber());  // get an account number

        // set saving balance and get total balance
        Double balTotal = n.getNetTotalBalance();
        String sBalTotal = String.format("%.2f", balTotal);

        // get a total withdraw limit of number
        Double balLimit = n.getNetWithdrawalLimit(); 
        String sBalLimit = String.format("%.0f", balLimit);

        String regDate = ca.getRegNet();   // get a registration date
    ...
    private void setNumberButtons() {
        ...
        btnEtr.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch (serviceChosen) {
                    case 1:
                        n.setWithdrawAction(dAmountNum);
                        System.out.println("withdraw action!");
                        continueAction();
                        break;
                    case 2:
                        n.setDepositAction(dAmountNum);
    ...
    private void setTransferButtons() {
        ...
        btnT1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                n.setTransferSubAction(dAmountNum);
                continueAction();
            }
        });
