 ...
 * @author kosuk
 */
public class UiFixed extends BankUi {
    ...
    public void showDetails() {
        String acFName = f.getFirstName();  //  get user first name
        String acLName = f.getLastName();   //  get user last name
        String acNum = Integer.toString(f.getAccountNumber());  // get an account number

        // set saving balance and get total balance
        Double balTotal = f.getFixedBalance();
        String sBalTotal = String.format("%.2f", balTotal);

        String regDate = ca.getRegFixed();   // get a registration date
    ...
    private void setNumberButtons() {
        ...
        btnEtr.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch (serviceChosen) {
                    case 1:
                        f.setWithdrawAction(dAmountNum);
                        System.out.println("withdraw action!");
                        continueAction();
                        break;
                    case 2:
                        f.setDepositAction(dAmountNum);
    ...
    private void setTransferButtons() {
        ...
        btnT1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                f.setTransferSubAction(dAmountNum);
                continueAction();
            }
        });
